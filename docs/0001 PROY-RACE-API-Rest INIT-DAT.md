...
| SpecialityId | Alias           | Descripcion                                           | default |
| ------------ | --------------- | ----------------------------------------------------- | ------- |
...
| DisciplineId | Alias         | Descripcion       | SpecialityId | FormatId | SurfaceId | default |
| ------------ | ------------- | ----------------- | ------------ | -------- | --------- | ------- |
...
| RolId | Descripción        | Pseudonimo      |
| ----- | ------------------ | --------------- |
| 1     | Administrador Club | ClubAdmin       |
| 2     | Tesorero           | Treasurer       |
| 3     | Socio              | Member          |
| 4     | Contacto           | Contact         |
| 5     | Invitado           | Guest           |
| 6     | Responsable Evento | EventResp       |
| 7     | Responsable Prueba | CompetitionResp |
...
| RolEntityId | EntityLinkId | RolId |
| ----------- | ------------ | ----- |         
| 1           | 1            |  1    |
| 2           | 1            |  2    |
| 3           | 1            |  3    |
